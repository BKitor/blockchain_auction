...
from test_app.models import Profile, SealedBid, English, Dutch, Channel
...
class EnglishTests(APITestCase):
    ...
    def test_english_get(self):
        url = '/auction/english_auction/1/'
        self._auth()
        response = self.client.get(url)
        self.assertEqual(response.data['auction_id'], 'sdfkj3')

    def test_english_post(self):
        url = '/auction/english_auction/'
        self._auth()
...
class ChannelTests(APITestCase):
    ...
    def test_channel_get(self):
        url = '/auction/channel_auction/1/'
        self._auth()
        response = self.client.get(url)
        self.assertEqual(response.data['auction_id'], 'sdfkj3')

    def test_channel_post(self):
        url = '/auction/channel_auction/'
        self._auth()
    ...
    def test_start_auction(self):
        url = '/auction/channel_auction/1/start/'
        self._auth()
        res = self.client.put(url)
        self.assertEqual(res.status_code, 400)


class SqueezeTests(APITestCase):
    ...
    def test_squeeze_get(self):
        url = '/auction/squeeze_auction/1/'
        self._auth()
        response = self.client.get(url)
        self.assertEqual(response.data['auction_id'], 'sdfkj3')
    ...
    def test_squeeze_post(self):
        ...
        response = self.client.post(url, data=new_p_data)
        self.assertEqual(response.data['auction_id'], new_p_data['auction_id'])
        self.assertEqual(response.data['rate'], new_p_data['rate'])

    def test_squeeze_put(self):
        url = '/auction/squeeze_auction/'
        self._auth()
    ...
    def test_start_auction(self):
        url = '/auction/squeeze_auction/1/start/'
        self._auth()
        res = self.client.put(url)
        self.assertEqual(res.status_code, 400)
